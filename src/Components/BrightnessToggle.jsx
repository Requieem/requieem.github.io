        ...
        return <div className={"border-1 rounded-md shadow-2xl p-2 flex-fow items-center justify-center flex-nowrap border-amber-300 dark:background-yinmn-blue/100 dark:border-yinmn-blue background-amber-300"}>
            ...
            <div className={"scale-80"}>
                <label className="cursor-pointer items-center justify-center flex">
                    <input type="checkbox" value="true" className="z-30 sr-only peer theme-box" onInput={this.toggleTheme}/>
                    <div
                        ...
                        <FaSun className="z-10 absolute dark:left-6 left-1 top-1 opacity-100 dark:opacity-0 fill-amber-300"/>
                        <FaMoon className="z-10 absolute dark:left-6 left-1 top-1 dark:opacity-100 opacity-0 fill-yinmn-blue"/>
                    </div>
                </label>
            </div>
        </div>;
